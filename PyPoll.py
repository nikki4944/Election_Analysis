...
candidate_options = []
#Declare a candiate votes dictionary
candidate_votes = {}
...
with open(file_to_save, "w") as txt_file:
    ...
    for candidate_name in candidate_votes:
        ...
        #To Do: Print out each candidate's name, vote count, and percentage of the total vote to the terminal
        candidate_results= (
    ...
    #To Do: Print the winning candidate's name, note count, and percentage of votes to the terminal
